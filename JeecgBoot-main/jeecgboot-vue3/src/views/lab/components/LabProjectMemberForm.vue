...
<script lang="ts">
    ...
    import {getBpmFormSchema} from '../LabProjectMember.data';
    import {saveOrUpdate} from '../LabProjectMember.api';
    
    export default defineComponent({
        name: "LabProjectMemberForm",
        components:{
            BasicForm
        },
        props:{
        ...
        setup(props){
            ...
            let formData = {};
            const queryByIdUrl = '/lab/labProjectMember/queryById';
