<template>
  <div :class="prefixCls" class="login-background-img">
    <AppLocalePicker class="absolute top-8 right-8 enter-x xl:text-gray-600" :showText="false"/>
    <AppDarkModeToggle class="absolute top-5 right-15 enter-x" />
                ...
                <div class="aui-form-box" style="height: 240px">
                    ...
                    <div class="aui-account">
                      ...
                      <div class="aui-inputClear">
                        ...
                        <div class="aui-code">
                          ...
                          <img v-else style="margin-top: 5px; max-width: initial" :src="codeImg" @click="handleChangeCheckCode" />
                        </div>
                      </div>
                  ...
                  <a-form v-else ref="phoneFormRef" :model="phoneFormData" @keyup.enter.native="loginHandleClick">
                    <div class="aui-account phone">
                      ...
                      <div class="aui-inputClear">
                        <a-input class="fix-auto-fill" :maxlength="20" :placeholder="t('sys.login.smsCode')" v-model:value="phoneFormData.smscode" />
...
<script lang="ts" setup name="login-mini">
  ...
  import logoImg from '/@/assets/loginmini/icon/shanghai_logo.png';
