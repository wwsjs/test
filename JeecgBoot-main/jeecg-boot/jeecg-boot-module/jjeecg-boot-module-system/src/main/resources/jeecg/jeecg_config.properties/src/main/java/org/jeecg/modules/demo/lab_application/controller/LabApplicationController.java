package org.jeecg.modules.legacy.lab_application.controller;
 ...
 */
@Tag(name="该表存储申请信息")
@RestController("legacyLabApplicationController")
@RequestMapping("/lab_application/labApplication")
@Slf4j
public class LabApplicationController extends JeecgController<LabApplication, ILabApplicationService> {
	...
	@RequiresPermissions("lab_application:lab_application:add")
	...
	@RequiresPermissions("lab_application:lab_application:edit")
	...
	@RequiresPermissions("lab_application:lab_application:delete")
	...
	@RequiresPermissions("lab_application:lab_application:deleteBatch")
    ...
    * @param labApplication
    */
    @RequiresPermissions("lab_application:lab_application:exportXls")
    ...
    * @return
    */
    @RequiresPermissions("lab_application:lab_application:importExcel")
