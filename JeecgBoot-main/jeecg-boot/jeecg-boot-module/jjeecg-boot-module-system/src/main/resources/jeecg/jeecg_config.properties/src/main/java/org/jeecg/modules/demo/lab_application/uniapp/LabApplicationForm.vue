<template>
    <view>
		...
		<cu-custom :bgColor="NavBarColor" isBack :backRouterName="backRouteName">
			...
			<block slot="content">该表存储申请信息</block>
		</cu-custom>
		 <!--表单区域-->
		<view>
			<form>
              ...
              <my-date label="createTime：" v-model="model.createTime" placeholder="请输入createTime"></my-date>
				<view class="padding">
    ...
    export default {
        ...
        data(){
            return {
                ...
                backRouteName:'index',
                url: {
                  queryById: "/lab_application/labApplication/queryById",
                  add: "/lab_application/labApplication/add",
