...
<script lang="ts">
    ...
    import {getBpmFormSchema} from '../LabApplication.data';
    import {saveOrUpdate} from '../LabApplication.api';
    ...
    export default defineComponent({
        ...
        setup(props){
            ...
            let formData = {};
            const queryByIdUrl = '/lab_application/labApplication/queryById';
