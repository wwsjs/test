...
public class LabUseRecord implements Serializable {
	...
	/**依托项目ID*/
	@Excel(name = "依托项目ID", width = 15, dictTable = "lab_project", dicText = "project_name", dicCode = "id")
	@Dict(dictTable = "lab_project", dicText = "project_name", dicCode = "id")
    @Schema(description = "依托项目ID")
