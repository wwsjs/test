...
public class LabApplicationController extends JeecgController<LabApplication, ILabApplicationService> {
	...
	@RequiresPermissions("application:lab_application:add")
	...
	@RequiresPermissions("application:lab_application:edit")
	...
	@RequiresPermissions("application:lab_application:delete")
	...
	@RequiresPermissions("application:lab_application:deleteBatch")
    ...
    * @param labApplication
    */
    @RequiresPermissions("application:lab_application:exportXls")
    ...
    * @return
    */
    @RequiresPermissions("application:lab_application:importExcel")
